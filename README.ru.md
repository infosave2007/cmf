...
Архитектура CMF выведена из физической теории автора — **Вакуумной массовой фракции (VMF)**, в рамке **Гравитации нулевого вектора (NVG)**. Двенадцать принципов NVG/VMF отображаются в конкретные элементы формата (единая основа, двухполевое `q8_2f`, маски задач, контракт качества на отложенных данных, резонансная маршрутизация, переменнобитный кодек…), с жёсткой границей между *измеренным* и оставшимся метафорой.

- **[Принципы VMF/NVG в основе CMF](VMF_principles_in_CMF.ru.md)** — полное отображение ([English](VMF_principles_in_CMF.md) · [中文](VMF_principles_in_CMF.zh.md)).
- **[Репозиторий теории NVG/VMF](https://github.com/infosave2007/vmf)** — сама физика.
